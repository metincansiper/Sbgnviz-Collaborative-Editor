...
module.exports = function(editorListeners){


    QUnit.module( "EditorListener tests to see if model is updated correctly." );
/*
...
*/
    ...
    function changeDataTest() {
        QUnit.test('editorListener.changeData', function (assert) {
