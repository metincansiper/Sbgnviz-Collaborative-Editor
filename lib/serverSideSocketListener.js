...
;
    ...
    var listenToAgentRequests = function(socket){
        ...
        socket.on('agentConnectToTripsRequest', function(){
            ...
            const tripsInterfaceModule = require('./tripsCausalityInterfaceModule.js')(socket, model);
            const tripsCausalityModule = require('./tripsCausalityTesterModule.js')(socket, model);
            const causalityNLGModule = require('./tripsCausalityNLGModule.js')(socket, model);
        });
