...
;
    ...
    var listenToAgentRequests = function(socket, socketRoom){
        ...
        socket.on('agentConnectToTripsRequest', function(){
            ...
            console.log("Connect to trips request");
            //let tripsSocketInterface handle therest
            var tripsInterfaceModule = require('./tripsCausalityInterfaceModule.js')(socket, model);
            //const tripsCausalityModule = require('./tripsCausalityTesterModule.js')(socket, model);
            var causalityNLGModule = require('./tripsCausalityNLGModule.js')(socket, model);
        });
