...
module.exports = function(socket, model, askHuman){
     ...
     */
    this.proposeGoal = function(text, goalId){
        ...
        //             0: 'ONT::RELN',
        //             1: 'ONT::V34567',
        //             'instance-of': 'ONT::CREATE',
        //             agent: 'ONT::V44003',
        //             'affected-result': 'ONT::V44004'
        //         },
        //         1: {0: 'ONT::A', 1: 'ONT::V44003', 'instance-of': 'ONT::PERSON', equals: 'ONT::US'},
        //         2: {0: 'ONT::TERM', 1: 'ONT::V44004', 'instance-of': 'ONT::STAIRS'}
        //     }
        // }});
    ...
    tm.init(function(){
        ...
        tm.addHandler(pattern, function (text) {
            ...
            var imgData = {img:contentObj.img, tabIndex: contentObj.tabIndex, tabLabel:contentObj.tabLabel, fileName:contentObj.fileName }
        ...
        tm.addHandler(pattern, function (text) { //listen to requests
            ...
            self.getTermName(contentObj.source, function (source) {
                self.getTermName(contentObj.target, function (target) {
                    ...
                    self.proposeGoal(text, contentObj.goal);
