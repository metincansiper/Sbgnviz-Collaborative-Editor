...
module.exports = function(socket, model){
    ...
    tm.init(function(){
        ...
        tm.addHandler(pattern, function (text) {
            ...
            tm.replyToMsg(textCorrelationRequestFromBA, {0: 'reply', content: {0: 'success'}});
        ...
        tm.addHandler(pattern, function (text) { //listen to requests
            ...
            self.getTermName(contentObj.sourceId, function (source) {
                self.getTermName(contentObj.targetId, function (target) {
